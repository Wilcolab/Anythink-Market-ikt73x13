...
describe('Edge Cases', function () {
    ...
    it('returns error for non-numeric operand1', function (done) {
        request.get('/arithmetic?operation=add&operand1=abc&operand2=1')
            .expect(400)
            .end(function (err, res) {
    ...
    it('returns error for non-numeric operand2', function (done) {
        request.get('/arithmetic?operation=add&operand1=1&operand2=xyz')
            .expect(400)
            .end(function (err, res) {
    ...
    it('returns error for missing operand2', function (done) {
        request.get('/arithmetic?operation=add&operand1=1')
            .expect(400)
            .end(function (err, res) {
